...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adView.setAdUnitId("ca-app-pub-6926702628956925/2570207801");
...
// Count the number of filled EditText fields
            ...
            if (enteredNumSubjects == numFilledSubjects) {
                ...
                Toast.makeText(this, "The no. of subjects passed & no.of box filled does not match...", Toast.LENGTH_LONG).show();
            }
